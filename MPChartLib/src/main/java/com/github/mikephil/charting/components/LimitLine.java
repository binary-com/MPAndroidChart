...
public class LimitLine extends ComponentBase {
    ...
    /**
     * indicates the background shape of the LimitLine label
     */
    private LimitLineLabelBackground mLabelBackground = LimitLineLabelBackground.None;

    /**
     * the style of the label background
     */
    private Paint.Style mLabelBackgroundStyle = Paint.Style.FILL_AND_STROKE;

    /**
     * the color of label background
     */
    ...
    /**
     * enum that indicate the background shape of the LimitLine label
     */
    public enum LimitLineLabelBackground {
        None, RECTANGLE, POLYGON
    }
    ...
    /**
     * Returns the label background shape that is drawn behind the limit line label
     *
     * @return
     */
    public LimitLineLabelBackground getLabelBackground() {
        return mLabelBackground;
    }

    /**
     * Sets the background of limit line label
     *
     * @param mLabelBackground
     */
    public void setLabelBackground(LimitLineLabelBackground mLabelBackground) {
        this.mLabelBackground = mLabelBackground;
    }

    /**
     * Retrieves the limit line label background's style
     *
     * @return
     */
    public Paint.Style getLabelBackgroundStyle() {
        return mLabelBackgroundStyle;
    }

    /**
     * Sets the limit line label background's style
     *
     * @param mLabelBackgroundStyle
     */
    public void setLabelBackgroundStyle(Paint.Style mLabelBackgroundStyle) {
        this.mLabelBackgroundStyle = mLabelBackgroundStyle;
    }

    /**
     * Retrieves limit line label background's color
     *
     * @return
     */
    ...
    /**
     * Sets label background's color of limit line
     *
     * @param mLabelBackgroundColor
     */
